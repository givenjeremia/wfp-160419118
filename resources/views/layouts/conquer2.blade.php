		...
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu">
				...
				<li >
					...
					<ul class="sub-menu">
						<li>
							<a href="/report/listcategory">
							Category Product</a>
						</li>
						<li>
							<a href="/report/listproduct">
							Product Name, Form And Category</a>
						</li>
						<li>
							{{-- href="/report/countcategorywithproduct"  --}}
							<a href="/report/countcategorywithproduct">
							Count Category With Product</a>
						</li>
						<li>
							<a href="/report/listcategorynoproduct">
							Category No Product</a>
						</li>
						<li>
							<a href="/report/averagepricecategory">
							Average Price Product Category</a>
						</li>
						<li>
							<a href="/report/categoryoneproduct">
							Category One Product</a>
						</li>
						<li>
							<a href="/report/productoneform">
							Product One Formula</a>
						</li>
						<li>
							<a href="/report/highproductprice">
							High Product Price</a>
						</li>
					</ul>
				</li>
				<li >
