...
<div class="portlet">
    ...
    <div class="portlet-body form">
        <!-- BEGIN FORM-->
        <form action="{{ route('obat.update',$product->id) }}" method="post" enctype="multipart/form-data" class="form-horizontal">
            @csrf
            @method('put')
            <div class="form-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" value="{{ $product->restriction_formula  }}" name="restriction_formula" class="form-control"
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="number" value="{{ $product->product_price  }}"  name="product_price" class="form-control" class="form-control"
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            <div class="col-md-offset-3 col-md-9">
                                ...
                                <a href="/obat" class="btn btn-default">Cancel</a>
